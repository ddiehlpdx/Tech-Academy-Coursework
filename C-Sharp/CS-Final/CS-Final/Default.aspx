...
<head runat="server">
    ...
    <meta name="description" content="Order some pizza." />
</head>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container bg-dark p-3">
            ...
            <div class="form-check">
                <asp:CheckBox ID="pepperoni" runat="server" AutoPostBack="True" OnCheckedChanged="pepperoni_CheckedChanged" />
                <label class="form-check-label" for="pepperoni">
                        Pepperoni
                </label>
            </div>
            <div class="form-check">
                <asp:CheckBox ID="sausage" runat="server" AutoPostBack="True" OnCheckedChanged="sausage_CheckedChanged" />
                <label class="form-check-label" for="sausage">
                    Sausage
                </label>
            </div>
            <div class="form-check">
                <asp:CheckBox ID="mushrooms" runat="server" AutoPostBack="True" OnCheckedChanged="mushrooms_CheckedChanged" />
                <label class="form-check-label" for="mushrooms">
                    Mushrooms
                </label>
            </div>
            <div class="form-check">
                <asp:CheckBox ID="peppers" runat="server" AutoPostBack="True" OnCheckedChanged="peppers_CheckedChanged" />
            ...
            &nbsp;<asp:Label ID="exceptionLabel" runat="server" Font-Bold="True"></asp:Label>
            <br />
        </div>
    </form>
